...
grep -q 'put_options "$root_id" GET,POST' "$ROOT_DIR/scripts/deploy-production-media-api.sh"
grep -q 'put_options "$songs_id" GET,POST' "$ROOT_DIR/scripts/deploy-production-media-api.sh"
grep -q 'put_options "$text_id" GET,POST' "$ROOT_DIR/scripts/deploy-production-media-api.sh"
